...
namespace Illuminate\Http {
    ...
    class RedirectResponse extends \Symfony\Component\HttpFoundation\RedirectResponse {
         ...
         * @static
         */
        public static function alertSuccess($message, $type = 'success', $title = 'Sucesso!')
        {
            return \Illuminate\Http\RedirectResponse::alertSuccess($message, $type, $title);
        }
         ...
         * @static
         */
        public static function alertFailure($message, $type = 'failure', $title = 'Erro!')
        {
            return \Illuminate\Http\RedirectResponse::alertFailure($message, $type, $title);
        }
         ...
         * @static
         */
        public static function alertWarning($message, $type = 'attention', $title = 'Atenção!')
        {
            return \Illuminate\Http\RedirectResponse::alertWarning($message, $type, $title);
        }
...
namespace  {
    ...
    class Eloquent extends \Illuminate\Database\Eloquent\Model {        /**
        ...
        /**
         * Edit records in a PostgreSQL database using the update from syntax.
         *
         * @return int
         * @static
         */
